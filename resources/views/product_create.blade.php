    ...
    {{ csrf_field() }}
      ...
      <div class="row">
        <div class="form-group">
            ...
            <select id="category_id" name="category_id" value="{{ old('category_id') }}" class="form-control">
      ...
      <div class="row">
        <div class="form-group">
          <label>Alergenos:</label>
              <div class="card-body">
                  <select data-placeholder="Seleccionar alergenos" multiple class="standardSelect" id="allergen" name="allergen[]" tabindex="5">
                      <option value=""></option>
